...
class TestDependencies:
    ...
    def test_dependencies_1(self):
        allure.dynamic.description("""this test should run first """)
    ...
    def test_dependencies_2(self):
        allure.dynamic.description(""" this test should run second """)
    ...
    def test_dependencies_3(self):
        allure.dynamic.description(""" this test should run third """)
    ...
    def test_dependencies_4(self):
        allure.dynamic.description(""" this test should run last 4 """)
    ...
    def test_dependencies_5(self):
        allure.dynamic.description(""" this test should run after test_dependencies_3 """)
    ...
    def test_dependencies_last(self):
        allure.dynamic.description(""" this test should run last """)
